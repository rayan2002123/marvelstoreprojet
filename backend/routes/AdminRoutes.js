...
router.get("/users", isRayan, async (req, res) => {
  try {
...
router.get("/orders", isRayan, async (req, res) => {
  try {
...
router.get("/carts", isRayan, async (req, res) => {
  try {
...
router.get("/addresses", isRayan, async (req, res) => {
  try {
...
router.delete("/user/:id", isRayan, async (req, res) => {
    try {
  ...
  router.delete("/order/:id", isRayan, async (req, res) => {
    try {
  ...
  router.delete("/cart/:id", isRayan, async (req, res) => {
    try {
  ...
  router.delete("/address/:id", isRayan, async (req, res) => {
    try {
...
router.put("/user/:id", isRayan, async (req, res) => {
...
router.put("/order/:id/status", isRayan, async (req, res) => {
...
router.put("/cart/:id", isRayan, async (req, res) => {
    try {
...
router.put("/address/:id", isRayan, async (req, res) => {
    try {
